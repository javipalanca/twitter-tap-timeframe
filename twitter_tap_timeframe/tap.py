...
def main():
    ...
    parser_search.add_argument('-tf', '--timeframes-collection', '--timeframes_collection',
                               dest='timeframes_collection',
                               type=six.text_type, default='timeframes',
                               help='The name of the collection for storing timeframes. Default is timeframes.')
    ...
    parser_stream.add_argument('-tc', '--tweets-collection', '--tweets_collection', dest='tweets_collection',
                               type=six.text_type, default='tweets',
                               help='The name of the collection for storing tweets. Default is tweets.')
    parser_stream.add_argument('-tf', '--timeframes-collection', '--timeframes_collection',
                               dest='timeframes_collection',
                               type=six.text_type, default='timeframes',
                               help='The name of the collection for storing timeframes. Default is timeframes.')
    ...
    if args.subcommand == 'search':
        ...
        timeframes = db[args.timeframes_collection]
